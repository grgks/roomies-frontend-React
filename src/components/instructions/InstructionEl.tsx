                ...
                <div className="flex flex-col gap-8">
                    ...
                    <section>
                        ...
                        <ul className="mt-2 flex flex-col gap-1 text-sm text-slate-600 list-disc list-inside">
                            ...
                            <li>Να δείτε ποιο Μερίδιο από Έξοδο που έχετε εσείς πληρώσει είναι πληρωμένο ή απλήρωτο από τους συγκατοίκους σας.</li>
                        </ul>
                    </section>
                    ...
                    <section>
                        ...
                        <ul className="flex flex-col gap-1 text-sm text-slate-600 list-disc list-inside">
                            <li><strong>ΠΡΟΣΟΧΗ:</strong> Μπορείτε να αξιολογήσετε Συγκάτοικους μόνο μια φορά. Δεν υπάρχει διόρθωση ή διαγραφή αξιολόγησης.</li>
                    ...
                    <section>
                        ...
                        <ul className="flex flex-col gap-1 text-sm text-slate-600 list-disc list-inside">
                            ...
                            <li>Αν δεν είστε σε Σπίτι μπορείτε να δείτε τον Μ.Ο απο τις αξιολογήσεις των Συγκατοίκων που βρίσκονται εκείνη τη στιγμή στο Σπίτι.</li>
