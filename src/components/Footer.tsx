                ...
                <div
                    ...
                    <div className="flex gap-10 mt-2 md:mt-0">
                        <a href="https://github.com/grgks" target="_blank" rel="noopener noreferrer"
                           className="text-white/60 hover:text-white hover:scale-180 transition" aria-label="GitHub">
                        ...
                        <a href="https://www.linkedin.com/in/giorgos-k-882332360/" target="_blank" rel="noopener noreferrer"
                           className="text-white/60 hover:text-white hover:scale-180 transition" aria-label="LinkedIn">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <a href="mailto:roomies@gmail.com"
                           className="text-white/60 hover:text-white hover:scale-180 transition" aria-label="Email">
